...
public:
  ...
  float L2Value() { return data.analog.button.l2; }
  float R2Value() { return data.analog.button.r2; }

  int8_t LStickX() { return data.analog.stick.lx; }
  float LStickY() { return data.analog.stick.ly; }
  int8_t RStickX() { return data.analog.stick.rx; }
  float RStickY() { return data.analog.stick.ry; }
